        ...
        <div class="table-responsive">
            <table id="tableId22222" class="table table-bordered table-sm table2excel_with_colors">
                ...
                <tr class="row0">
                    ...
                    <th class="column51 style7 s style7" colspan="10" rowspan="1">Данные по индивидуальной и коллективной оценке уровня тревожности и агрессии</th>
                </tr>
                <tr class="row1">
                    ...
                    <th class="column23 style6 null style6" colspan="2">Оценка уровня реактивной и личностной тревожности</th>
                    <th class="column23 style6 null style6" rowspan="2">Опросник на наличие симптомов беспокойства и нервозности</th>
                    <th class="column23 style6 null style6" rowspan="2">Опросник индикации возможных причин тревожности</th>
                    <th class="column23 style6 null style6" rowspan="2">Меры профилактики, реализуемые в отношении ребенка со стороны учителей</th>
                    <th class="column23 style6 null style6" rowspan="2">Меры профилактики, реализуемые в отношении ребенка со стороны родителей - законных представителей</th>
                    <th class="column23 style6 null style6" rowspan="2">Опросник формы проявления агрессии у ребенка</th>
                    <th class="column23 style6 null style6" rowspan="2">Опросник индикации возможных причин агрессивности ребенка</th>
                    <th class="column23 style6 null style6" colspan="2">Опросник диагностики агрессии по Басса-Дарки</th>
                </tr>
                <tr class="row2">
                    ...
                    <th class="column53 style16 s">РТ</th>
                    <th class="column53 style16 s">ЛТ</th>
                    <th class="column53 style16 s">Индекс агрессивности</th>
                    <th class="column53 style16 s">Индекс враждебности</th>
                </tr>
                </thead>
                <tbody>
                <?
