...
$this->title = 'Результаты медицинских осмотров на начало учебного года';
/*print_r('<pre>');
print_r($patients);
print_r('</pre> <br>');
...
?>
    ...
    <div class="container">
        <div class="blockView p-2">
            ...
            <h5 class="text-center text-danger"><i>Заполняется для <?= Yii::$app->riskComponent->trainingClass($modelF->class) ?></i></h5>
            <?= Html::a(
                'Вернуться назад',
