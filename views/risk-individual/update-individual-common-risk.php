...
?>
    ...
    <div class="blockView p-2">
        ...
        <h6 class="text-center text-danger"><i>(ответы формируются интервьюером, по каждому респонденту отдельно)</i></h6>
        <h6 class="text-center text-primary"><i>Если у респондента есть нарушение осанки и зрения на момент последнего медицинского осмотра, индивидуальный риск не оценивается</i></h6>
        <?= Html::a(
            'Вернуться назад',
